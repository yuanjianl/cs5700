...
<p>
<b>This project is due at 11:59pm on November 14, 2014.</b>
</p><p>
<h2>Description</h2>
...
project 2 to aid in the process. However, <b>your program must use an SOCK_RAW/IPPROTO_RAW socket</b>,
...
For example, in C a socket of type SOCK_RAW/IPPROTO_RAW bypasses the operating system's IP and TCP/UDP layers.
In your program, you will need to create two raw sockets: one for receiving packets and one for
sending packets. The receive socket must be of type SOCK_RAW/IPPROTO_IP; the send socket must be
of type SOCK_RAW/IPPROTO_RAW. The reason you need two sockets has to do with some quirks of the Linux kernel.
The kernel will not deliver any packets to sockets of type SOCK_RAW/IPPROTO_RAW, thus your code will
...
When you start to write your program, you will immediately notice that the SOCK_RAW/IPPROTO_IP receive
...
your own Linux machine, or in a VM. We will be grading your code on a stock Ubuntu Linux 12.04 machine,
...
on a <b>stock</b> copy of Ubuntu 12.04 <b>on the command line</b>.
</p><p>
...
<pre>$ /course/cs5700f14/bin/register project4 [team name]</pre>
...
<pre>$ /course/cs5700f14/bin/turnin project4 [project directory]</pre>
...
implemented Ethernet functionality, and any additional challenges your faced (e.g. ARP).
 ...
 <script>
    ...
    <hr>
    <p>David Choffnes, Assistant Professor, College of Computer &amp; Information Science, Northeastern University. &copy; 2014<br>
    Last updated
